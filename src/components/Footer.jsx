      ...
      <div className="mx-auto max-w-7xl px-6 sm:px-10">
        ...
        <div className="grid gap-10 md:grid-cols-4 pb-12 border-b border-[#EAE3D9] dark:border-[#2D2A26]">
          ...
          <div className="md:col-span-2 space-y-4">
            ...
            <p className="text-xs sm:text-sm max-w-sm leading-relaxed text-[#5C554E] dark:text-[#A39B8E]">
          ...
          <div>
            <h4 className="text-xs font-bold uppercase tracking-wider text-[#121110] dark:text-[#FAF6F0] mb-4 flex items-center gap-1.5">
              <FiTerminal className="h-3.5 w-3.5 text-[#C85A32]" />
              Stack & Code
            </h4>
        ...
        <div className="mt-8 flex flex-col sm:flex-row items-center justify-between gap-6">
            ...
            {[
              ...
              return (
                <a
                  ...
                  rel="noreferrer"
                  aria-label={s.name}
                  className="p-2.5 rounded-full border border-[#EAE3D9] dark:border-[#2D2A26] bg-[#FAF6F0] dark:bg-[#1E1B18] text-[#121110] dark:text-[#FAF6F0] hover:text-[#C85A32] dark:hover:text-[#C85A32] hover:border-[#C85A32] transition cursor-pointer"
                >
          ...
          <button
            onClick={scrollToTop}
            className="flex items-center gap-2 px-4 py-2 rounded-full border border-[#EAE3D9] dark:border-[#2D2A26] bg-[#FAF6F0] dark:bg-[#1E1B18] text-xs font-semibold text-[#121110] dark:text-[#FAF6F0] hover:border-[#C85A32] hover:text-[#C85A32] transition cursor-pointer"
          >
